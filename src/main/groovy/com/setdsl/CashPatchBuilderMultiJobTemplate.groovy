                ...
                phase('Build distributions') {
                    phaseJob('build_pos_cash_tar') {
                        ...
                        parameters {
                            ...
                            predefinedProp('CUSTOM_WORKSPACE', '/var/lib/jenkins/jobs/build_cash_patch/workspace/version_from/')
                            sameNode()
                        }
                    }
                    ...
                    phaseJob('build_pos_cash_tar') {
                        ...
                        parameters {
                            ...
                            predefinedProp('CUSTOM_WORKSPACE', '/var/lib/jenkins/jobs/build_cash_patch/workspace/version_to/')
                            sameNode()
                        }
                    }
                }
